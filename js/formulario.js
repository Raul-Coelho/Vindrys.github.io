...
function verificarCadastro() {
    ...
    if ((nome_Usuario != "") && (validarCpf(cpf_Usuario) != false) && (rua_Usuario != "") && (validarData(data_Nasc_Usuario) != false) && (bairro_Usuario != "") && (numero_Usuario != "") && (validarTelefone(telefone_Usuario) != false) && (validarCep(cep_Usuario) != false) && (validarRg(rg_Usuario) != false) && (email_Usuario != "") && (senha_Usuario != "")) {
